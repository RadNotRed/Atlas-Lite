...
call setSvc.cmd KSecPkg 4 > nul 2>&1
call setSvc.cmd LanmanServer 4 > nul 2>&1
call setSvc.cmd LanmanWorkstation 4 > nul 2>&1
call setSvc.cmd mrxsmb 4 > nul 2>&1
call setSvc.cmd mrxsmb20 4 > nul 2>&1
call setSvc.cmd rdbss 3 > nul 2>&1
call setSvc.cmd srv2 4 > nul 2>&1
